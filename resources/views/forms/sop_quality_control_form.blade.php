@foreach ($sopQualityControlDataset as $dataSet)
    ...
    <form action="{{ url('hod/capa_actions/sop_quality_control') }}/{{ $dataSet->id }}" enctype="multipart/form-data" method="post">
        ...
        <table class="table table-bordered">
            ...
            <tbody id="chemical_required_qc">
                @if (($documentData != null) && ($documentData['chemical_required']['checmical_name'] != null))
        ...
        <table class="table table-bordered">
            ...
            <tbody id="apparatus_required">
                @if (($documentData != null) && ($documentData['apparatus_required']['apparatus_name'] != null))
